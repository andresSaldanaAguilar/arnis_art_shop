...
const item4 = {
  image: Keane,
  imageRef: KeaneRef,
  title: 'Keane',  description: 'Keane es mi banda favorita de la adolescencia y estuvieron haciendo tour por distintas regiones de mexico, entonces decidi hacer mi primer dibujo semi-automatico conmemorando su 20 aniversario, usando los colores de referencia que venian en la fotografia original, no fue tan sencillo pero haber logrado captar la escencia de cada integrante, los créditos y autoría de la fotografia no pertenecen, dejo el link.',
  cost: 600,
  ...
  return (
    <div className="App">
      ...
      <div>
        <Row>
          <Col xs={12} md={4}>
            <Frame {...item5} onClick={() => setIsPanelOpen(true)} setItem={setItem}></Frame>
          </Col>
          <Col xs={12} md={4}>
            <Frame {...item4} onClick={() => setIsPanelOpen(true)} setItem={setItem}></Frame>
          </Col>
          <Col xs={12} md={4}>
